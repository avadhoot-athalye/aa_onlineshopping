...
<div class="row div-featured">
	<div class="col-md-3 font-style featured-content">
		<ul>
		...
		<ul>
			<h5><a href="#">BROWSE BY GENRE</a></h5>
		...
		<ul>
			<h5><a href="#">BROWSE BY PLATFORM</a></h5>
	...
	<div class="col-md-9 ">
		<div id="myCarousel" class="mainright carousel slide home-adjust"
			data-ride="carousel">
			<!-- Indicators -->
